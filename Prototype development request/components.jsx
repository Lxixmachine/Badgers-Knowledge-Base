...
const ICON_PATHS = {
  ...
  link:    <><path d="M10 14a5 5 0 007.1 0l2.4-2.4a5 5 0 00-7.1-7.1l-1.2 1.2"/><path d="M14 10a5 5 0 00-7.1 0l-2.4 2.4a5 5 0 007.1 7.1l1.2-1.2"/></>,
};
      ...
      <div className="detail__panel" ref={ref} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="detail__inner">
          ...
          <div className="detail__tags">
            {tags && entryTags.map((t) => <span key={t} className="chip chip--static">#{t}</span>)}
          </div>
        </div>
