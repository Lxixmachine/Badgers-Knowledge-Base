...
(() => {
  ...
  function validGoalFocus(value) {
    return isRecord(value) && isString(value.title) && value.title.length <= MINDSET_MAX_GOAL_SHORT_TEXT_LENGTH && isSafeString(value.why) && isSafeString(value.successDefinition) && isString(value.targetDate) && value.targetDate.length <= 20;
  }
  ...
  function validGoalAction(value) {
    return isRecord(value) && isGoalId(value.id) && isGoalShortString(value.title) && GOAL_ACTION_CATEGORY_VALUES.has(value.category) && Number.isInteger(value.weeklyTarget) && value.weeklyTarget >= 1 && value.weeklyTarget <= MINDSET_MAX_GOAL_WEEKLY_TARGET && isGoalShortString(value.cue) && isGoalShortString(value.proof);
  }
  function validGoalCurrentWeek(value, actions) {
    ...
    const actionMap = actions.reduce((result, action) => {
  ...
  function validGoalAccountability(value) {
    return isRecord(value) && ["partnerName", "method", "reviewDay", "reviewTime"].every((key) => isGoalShortString(value[key])) && isSafeString(value.checkInPrompt) && isSafeString(value.resetPlan);
  }
  ...
  function validGoalReview(value) {
    return isRecord(value) && isGoalId(value.id) && isString(value.weekOf) && value.weekOf.length <= 20 && validGoalFocus(value.goal) && Array.isArray(value.actions) && value.actions.length <= MINDSET_MAX_GOAL_ACTIONS && value.actions.every(validGoalReviewAction) && entriesHaveUniqueIds(value.actions) && ["win", "obstacle", "adjustment"].every((key) => isSafeString(value[key])) && typeof value.checkInCompleted === "boolean" && isGoalShortString(value.createdAt) && isGoalShortString(value.updatedAt);
  }
  function validGoalSystem(value) {
    ...
    return Array.isArray(value.reviews) && value.reviews.length <= MINDSET_MAX_GOAL_REVIEWS && value.reviews.every(validGoalReview) && entriesHaveUniqueIds(value.reviews);
  }
  ...
  function goalReviewFromSystem(goalSystem, id = makeMindsetId("goal-review"), timestamp = (/* @__PURE__ */ new Date()).toISOString()) {
    return {
      id,
  ...
  function TextField({ id, label, value, onChange, placeholder, multiline = false, rows = 3, type = "text", required = false, maxLength }) {
    const controlProps = {
      ...
      placeholder,
      required,
      maxLength: type === "date" || type === "time" ? void 0 : maxLength || (multiline ? MINDSET_MAX_TEXT_LENGTH : 180)
    };
  ...
  function SelectField({ id, label, value, onChange, options, required = false }) {
    return /* @__PURE__ */ React.createElement("label", { className: "wb-field", htmlFor: id }, /* @__PURE__ */ React.createElement("span", { className: "wb-field-label" }, label, !required && /* @__PURE__ */ React.createElement("span", { className: "wb-field-optional" }, "Optional")), /* @__PURE__ */ React.createElement("select", { id, className: "wb-field-control", value, onChange: (event) => onChange(event.target.value), required }, !required && /* @__PURE__ */ React.createElement("option", { value: "" }, "Choose one"), options.map((option) => /* @__PURE__ */ React.createElement("option", { value: option.value, key: option.value }, option.label))));
  }
  ...
  function DashboardCard({ module, title, description, summary, progress, progressTotal, buttonLabel, onOpen, history }) {
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "wb-module-card-heading" }, /* @__PURE__ */ React.createElement("span", { className: "wb-module-card-icon", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement(Icon, { name: module === "baseline" || module === "development" ? "brain" : module === "game-plan" || module === "goal-system" ? "target" : module === "pre-match" ? "flag" : "check", size: 22, stroke: 2 })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", null, title), /* @__PURE__ */ React.createElement("p", null, description))),
  ...
  function GoalScoreboard({ goalSystem, onChange, onSaveWeek, displayedSummary, currentSummary, summaryLabel, summaryRef, copyStatus, onCopySummary, onShowCurrentSummary }) {
    ...
    return /* @__PURE__ */ React.createElement("form", { className: "wb-form-section wb-goal-scoreboard", "aria-labelledby": "wb-goal-scoreboard-title", onSubmit: saveWeek }, /* @__PURE__ */ React.createElement("div", { className: "wb-goal-section-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "wb-eyebrow" }, "Act, score, adjust"), /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-scoreboard-title" }, "This week's scoreboard"), /* @__PURE__ */ React.createElement("p", null, "Count the controllable work you completed. A missed rep is information for the next adjustment, not a verdict.")), /* @__PURE__ */ React.createElement("div", { className: "wb-goal-score-total", "aria-label": stats.completed + " of " + stats.target + " planned action repetitions complete" }, /* @__PURE__ */ React.createElement("strong", null, stats.completed, "/", stats.target), /* @__PURE__ */ React.createElement("span", null, stats.percent, "% complete"))), nonEmpty(goalSystem.goal.title) && /* @__PURE__ */ React.createElement("aside", { className: "wb-goal-active-focus", "aria-label": "Active goal and accountability schedule" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Active goal"), /* @__PURE__ */ React.createElement("strong", null, goalSystem.goal.title), nonEmpty(goalSystem.goal.successDefinition) && /* @__PURE__ */ React.createElement("small", null, goalSystem.goal.successDefinition), nonEmpty(goalSystem.goal.targetDate) && /* @__PURE__ */ React.createElement("small", null, "Target ", displayDate(goalSystem.goal.targetDate))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Next check-in"), /* @__PURE__ */ React.createElement("strong", null, [goalSystem.accountability.reviewDay, goalSystem.accountability.reviewTime].filter(nonEmpty).join(" · ") || "Choose a review day below"), nonEmpty(goalSystem.accountability.partnerName) && /* @__PURE__ */ React.createElement("small", null, "With ", goalSystem.accountability.partnerName, nonEmpty(goalSystem.accountability.method) ? " via " + goalSystem.accountability.method : ""))), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-week-of", type: "date", label: "Week beginning", value: currentWeek.weekOf, onChange: (value) => setCurrentWeekField("weekOf", value), required: true }), stats.actions.length ? /* @__PURE__ */ React.createElement("div", { className: "wb-goal-score-list" }, stats.actions.map((action) => {
      var _a;
      const completed = currentWeek.completions[action.id] || 0;
      return /* @__PURE__ */ React.createElement("article", { className: "wb-goal-score-row", key: action.id }, /* @__PURE__ */ React.createElement("div", { className: "wb-goal-score-copy" }, /* @__PURE__ */ React.createElement("strong", null, action.title), /* @__PURE__ */ React.createElement("span", null, ((_a = GOAL_ACTION_CATEGORIES.find((category) => category.value === action.category)) == null ? void 0 : _a.label) || "Action", " · target ", action.weeklyTarget, "/week"), /* @__PURE__ */ React.createElement("progress", { max: action.weeklyTarget, value: completed, "aria-label": action.title + ": " + completed + " of " + action.weeklyTarget + " complete" })), /* @__PURE__ */ React.createElement("div", { className: "wb-goal-count", role: "group", "aria-label": action.title + " completion controls" }, /* @__PURE__ */ React.createElement("button", { className: "wb-goal-count-button", type: "button", disabled: completed <= 0, onClick: () => setActionCount(action, completed - 1), "aria-label": "Remove one completed rep for " + action.title + ", currently " + completed + " of " + action.weeklyTarget }, "−"), /* @__PURE__ */ React.createElement("output", { "aria-live": "polite", "aria-atomic": "true" }, /* @__PURE__ */ React.createElement("strong", null, completed), /* @__PURE__ */ React.createElement("small", null, "of ", action.weeklyTarget)), /* @__PURE__ */ React.createElement("button", { className: "wb-goal-count-button", type: "button", disabled: completed >= action.weeklyTarget, onClick: () => setActionCount(action, completed + 1), "aria-label": "Mark one completed rep for " + action.title + ", currently " + completed + " of " + action.weeklyTarget }, "+")));
    })) : /* @__PURE__ */ React.createElement("p", { className: "wb-empty-copy" }, "Add a named weekly action below, then its counter will appear here."), /* @__PURE__ */ React.createElement("div", { className: "wb-field-grid wb-goal-review-grid" }, /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-week-win", label: "A win from this week", value: currentWeek.win, onChange: (value) => setCurrentWeekField("win", value), placeholder: "What worked or moved me forward?", multiline: true }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-week-obstacle", label: "The main barrier", value: currentWeek.obstacle, onChange: (value) => setCurrentWeekField("obstacle", value), placeholder: "What made the plan harder to follow?", multiline: true }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-week-adjustment", label: "My next adjustment", value: currentWeek.adjustment, onChange: (value) => setCurrentWeekField("adjustment", value), placeholder: "One specific change for next week", multiline: true })), /* @__PURE__ */ React.createElement("section", { className: "wb-goal-score-share", "aria-labelledby": "wb-goal-score-share-title" }, /* @__PURE__ */ React.createElement("div", { className: "wb-goal-section-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", { id: "wb-goal-score-share-title" }, "Copy → share → save"), /* @__PURE__ */ React.createElement("p", null, "Review the summary, send only what you are comfortable sharing, mark the check-in, then save the week.")), /* @__PURE__ */ React.createElement("span", { className: "wb-editing-badge" }, summaryLabel)), /* @__PURE__ */ React.createElement("label", { className: "wb-field", htmlFor: "wb-goal-share-summary" }, /* @__PURE__ */ React.createElement("span", { className: "wb-field-label" }, "Accountability summary"), /* @__PURE__ */ React.createElement("textarea", { ref: summaryRef, id: "wb-goal-share-summary", className: "wb-field-control wb-goal-summary", value: displayedSummary, readOnly: true, rows: "10" })), /* @__PURE__ */ React.createElement("div", { className: "wb-form-actions" }, /* @__PURE__ */ React.createElement("button", { className: "wb-secondary-button", type: "button", onClick: () => onCopySummary(currentSummary, "Current week summary") }, /* @__PURE__ */ React.createElement(Icon, { name: "link", size: 18, stroke: 2 }), "Copy current check-in"), displayedSummary !== currentSummary && /* @__PURE__ */ React.createElement("button", { className: "wb-secondary-button", type: "button", onClick: onShowCurrentSummary }, "Show current week")), /* @__PURE__ */ React.createElement("p", { className: "wb-form-message", role: "status", "aria-live": "polite" }, copyStatus)), /* @__PURE__ */ React.createElement("label", { className: "wb-goal-check", htmlFor: "wb-goal-check-in-complete" }, /* @__PURE__ */ React.createElement("input", { id: "wb-goal-check-in-complete", type: "checkbox", checked: currentWeek.checkInCompleted, onChange: (event) => setCurrentWeekField("checkInCompleted", event.target.checked) }), /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 17, stroke: 2.4 }), "I shared this week's check-in with my accountability person.")), /* @__PURE__ */ React.createElement("div", { className: "wb-form-actions" }, /* @__PURE__ */ React.createElement("button", { className: "wb-primary-button", type: "submit" }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 18, stroke: 2.4 }), "Save weekly review")), /* @__PURE__ */ React.createElement("p", { className: "wb-form-message", role: "status", "aria-live": "polite" }, message));
  }
  function GoalSystemModule({ goalSystem, worksheetProgress, onChange, onSaveWeek, onReopenReview, onDeleteReview, onOpenWorksheets, onBack, backLabel }) {
    ...
    const scoreboard = /* @__PURE__ */ React.createElement(
      GoalScoreboard,
      {
        goalSystem,
        onChange,
    ...
    return /* @__PURE__ */ React.createElement("section", { className: "wb-module wb-goal-system", "aria-labelledby": "wb-goal-system-title" }, /* @__PURE__ */ React.createElement(
      ModuleHeader,
      {
    ...
    ), scoreboardFirst && scoreboard, /* @__PURE__ */ React.createElement("section", { className: "wb-goal-roadmap", "aria-labelledby": "wb-goal-roadmap-title" }, /* @__PURE__ */ React.createElement("div", { className: "wb-goal-roadmap-heading" }, /* @__PURE__ */ React.createElement(Icon, { name: "target", size: 23, stroke: 2 }), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "wb-eyebrow" }, "The loop"), /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-roadmap-title" }, "Direction becomes accountability"))), /* @__PURE__ */ React.createElement("ol", null, /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Define one focus."), /* @__PURE__ */ React.createElement("span", null, "Name the goal, why it matters, and what success will look like.")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Score controllable actions."), /* @__PURE__ */ React.createElement("span", null, "Track the work you can actually choose, not only wins or outcomes.")), /* @__PURE__ */ React.createElement("li", null, /* @__PURE__ */ React.createElement("strong", null, "Review and share."), /* @__PURE__ */ React.createElement("span", null, "Save the week, adjust without shame, and send a concise check-in.")))), /* @__PURE__ */ React.createElement("section", { className: "wb-goal-worksheet-link", "aria-labelledby": "wb-goal-worksheet-title" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "wb-eyebrow" }, "Build the foundation first"), /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-worksheet-title" }, "Five Goal Setting worksheets"), /* @__PURE__ */ React.createElement("p", null, "The full worksheets help you clarify long-term purpose, commitments, actions, accountability, and reminders. Use this system to carry that thinking into each week.")), /* @__PURE__ */ React.createElement("div", { className: "wb-goal-worksheet-progress" }, /* @__PURE__ */ React.createElement(ProgressMeter, { value: worksheetProgress.complete, total: worksheetProgress.total, label: "Goal Setting worksheet fields" }), /* @__PURE__ */ React.createElement("button", { className: "wb-secondary-button", type: "button", onClick: onOpenWorksheets }, "Open Goal Setting worksheets", /* @__PURE__ */ React.createElement(Icon, { name: "chevron", size: 17, stroke: 2.2 })))), /* @__PURE__ */ React.createElement("section", { className: "wb-form-section", id: "wb-goal-foundation", "aria-labelledby": "wb-goal-foundation-title" }, /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-foundation-title" }, "1. Define one focus goal"), /* @__PURE__ */ React.createElement("p", null, "Choose one goal for the next several weeks. Keep the outcome meaningful, then use your weekly actions as the score you control."), /* @__PURE__ */ React.createElement("div", { className: "wb-field-grid" }, /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-title", label: "My focus goal", value: goalSystem.goal.title, onChange: (value) => setGoalField("title", value), placeholder: "Example: Become dependable from bottom by the conference meet", multiline: true, required: true, maxLength: MINDSET_MAX_GOAL_SHORT_TEXT_LENGTH }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-why", label: "Why this matters to me", value: goalSystem.goal.why, onChange: (value) => setGoalField("why", value), placeholder: "The personal reason I am willing to work for it", multiline: true, required: true }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-success", label: "How I will know I made progress", value: goalSystem.goal.successDefinition, onChange: (value) => setGoalField("successDefinition", value), placeholder: "Observable evidence, skill standard, or result", multiline: true, required: true }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-target-date", type: "date", label: "Target date", value: goalSystem.goal.targetDate, onChange: (value) => setGoalField("targetDate", value), required: true }))), /* @__PURE__ */ React.createElement("section", { className: "wb-form-section", "aria-labelledby": "wb-goal-actions-title" }, /* @__PURE__ */ React.createElement("div", { className: "wb-goal-section-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-actions-title" }, "2. Build the weekly action plan"), /* @__PURE__ */ React.createElement("p", null, "Use a verb, a realistic weekly target, a cue for when it happens, and simple proof that tells you it was done.")), /* @__PURE__ */ React.createElement("button", { id: "wb-goal-add-action", className: "wb-secondary-button", type: "button", onClick: addAction, disabled: goalSystem.actions.length >= MINDSET_MAX_GOAL_ACTIONS }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 18, stroke: 2.2 }), "Add action")), /* @__PURE__ */ React.createElement("aside", { className: "wb-curriculum-notice" }, /* @__PURE__ */ React.createElement(Icon, { name: "check", size: 20, stroke: 2 }), /* @__PURE__ */ React.createElement("p", null, "Example: “Complete 10 minutes of bottom-position work after practice Tuesday and Thursday; proof is a note in my practice log.” Training, recovery, and nutrition actions should follow your coach and care-team guidance.")), goalSystem.actions.length ? /* @__PURE__ */ React.createElement("div", { className: "wb-goal-actions" }, goalSystem.actions.map((action, index) => /* @__PURE__ */ React.createElement("article", { className: "wb-goal-action-card", key: action.id }, /* @__PURE__ */ React.createElement("header", { className: "wb-goal-action-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", null, "Action ", index + 1), /* @__PURE__ */ React.createElement("strong", null, nonEmpty(action.title) ? action.title : "Name this action")), /* @__PURE__ */ React.createElement("button", { className: "wb-danger-button", type: "button", onClick: () => removeAction(action, index), "aria-label": "Remove action " + (index + 1) }, /* @__PURE__ */ React.createElement(Icon, { name: "trash", size: 17, stroke: 2 }), "Remove")), /* @__PURE__ */ React.createElement("div", { className: "wb-goal-action-grid" }, /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-action-title-" + action.id, label: "Controllable action", value: action.title, onChange: (value) => setAction(action.id, "title", value), placeholder: "The exact work I will do", required: true }), /* @__PURE__ */ React.createElement(SelectField, { id: "wb-goal-action-category-" + action.id, label: "Area", value: action.category, onChange: (value) => setAction(action.id, "category", value), options: GOAL_ACTION_CATEGORIES, required: true }), /* @__PURE__ */ React.createElement("label", { className: "wb-field", htmlFor: "wb-goal-action-target-" + action.id }, /* @__PURE__ */ React.createElement("span", { className: "wb-field-label" }, "Target per week"), /* @__PURE__ */ React.createElement("select", { id: "wb-goal-action-target-" + action.id, className: "wb-field-control", value: action.weeklyTarget, onChange: (event) => setAction(action.id, "weeklyTarget", Number(event.target.value)) }, Array.from({ length: MINDSET_MAX_GOAL_WEEKLY_TARGET }, (_, number) => number + 1).map((target) => /* @__PURE__ */ React.createElement("option", { value: target, key: target }, target, " ", target === 1 ? "time" : "times")))), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-action-cue-" + action.id, label: "When or where", value: action.cue, onChange: (value) => setAction(action.id, "cue", value), placeholder: "Example: after practice Tue/Thu" }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-action-proof-" + action.id, label: "Proof it is complete", value: action.proof, onChange: (value) => setAction(action.id, "proof", value), placeholder: "Example: practice-log note" }))))) : /* @__PURE__ */ React.createElement("div", { className: "wb-goal-empty-action" }, /* @__PURE__ */ React.createElement("p", null, "No weekly actions yet. Start with the smallest action that would make the goal more likely."), /* @__PURE__ */ React.createElement("button", { className: "wb-primary-button", type: "button", onClick: addAction }, /* @__PURE__ */ React.createElement(Icon, { name: "plus", size: 18, stroke: 2.2 }), "Add my first action")), /* @__PURE__ */ React.createElement("p", { className: "wb-form-message" }, goalSystem.actions.length, " of ", MINDSET_MAX_GOAL_ACTIONS, " action slots used. Three to five focused actions is usually enough.")), /* @__PURE__ */ React.createElement("section", { className: "wb-form-section", "aria-labelledby": "wb-goal-accountability-title" }, /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-accountability-title" }, "3. Set supportive accountability"), /* @__PURE__ */ React.createElement("p", null, "Choose someone who can help you review the plan honestly without policing, shaming, or taking ownership away from you."), /* @__PURE__ */ React.createElement("div", { className: "wb-field-grid" }, /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-partner", label: "Trusted person", value: goalSystem.accountability.partnerName, onChange: (value) => setAccountabilityField("partnerName", value), placeholder: "Name or role" }), /* @__PURE__ */ React.createElement(SelectField, { id: "wb-goal-method", label: "Check-in method", value: goalSystem.accountability.method, onChange: (value) => setAccountabilityField("method", value), options: [
      ...
      { value: "Other", label: "Other" }
    ] }), /* @__PURE__ */ React.createElement(SelectField, { id: "wb-goal-review-day", label: "Review day", value: goalSystem.accountability.reviewDay, onChange: (value) => setAccountabilityField("reviewDay", value), options: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => ({ value: day, label: day })) }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-review-time", type: "time", label: "Review time", value: goalSystem.accountability.reviewTime, onChange: (value) => setAccountabilityField("reviewTime", value) }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-support-request", label: "The exact support I am asking for", value: goalSystem.accountability.checkInPrompt, onChange: (value) => setAccountabilityField("checkInPrompt", value), placeholder: "Example: Ask what I learned and what I will adjust—do not lecture me", multiline: true }), /* @__PURE__ */ React.createElement(TextField, { id: "wb-goal-reset-plan", label: "My shame-free reset plan", value: goalSystem.accountability.resetPlan, onChange: (value) => setAccountabilityField("resetPlan", value), placeholder: "What I will do after a missed day or difficult week", multiline: true }))), !scoreboardFirst && scoreboard, /* @__PURE__ */ React.createElement("section", { className: "wb-history", "aria-labelledby": "wb-goal-history-title" }, /* @__PURE__ */ React.createElement("header", { className: "wb-history-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h3", { id: "wb-goal-history-title" }, "Weekly goal history"), /* @__PURE__ */ React.createElement("p", null, goalSystem.reviews.length, " saved ", goalSystem.reviews.length === 1 ? "review" : "reviews"))), !goalSystem.reviews.length && /* @__PURE__ */ React.createElement("p", { className: "wb-empty-copy" }, "Saved weekly goal reviews will appear here with the exact action plan and scores from that week."), !!goalSystem.reviews.length && /* @__PURE__ */ React.createElement("div", { className: "wb-history-list" }, goalSystem.reviews.map((review) => {
      ...
      return /* @__PURE__ */ React.createElement("article", { className: "wb-history-card wb-goal-history-card", key: review.id }, /* @__PURE__ */ React.createElement("header", null, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", null, "Week of ", displayDate(review.weekOf)), /* @__PURE__ */ React.createElement("p", null, review.goal.title || "Goal review")), /* @__PURE__ */ React.createElement("span", null, completed, "/", target)), /* @__PURE__ */ React.createElement("dl", { className: "wb-history-details" }, /* @__PURE__ */ React.createElement("dt", null, "Actions"), /* @__PURE__ */ React.createElement("dd", null, /* @__PURE__ */ React.createElement("ul", null, review.actions.map((action) => /* @__PURE__ */ React.createElement("li", { key: action.id }, action.title, ": ", action.completed, "/", action.weeklyTarget)))), nonEmpty(review.win) && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("dt", null, "Win"), /* @__PURE__ */ React.createElement("dd", null, review.win)), nonEmpty(review.obstacle) && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("dt", null, "Barrier"), /* @__PURE__ */ React.createElement("dd", null, review.obstacle)), nonEmpty(review.adjustment) && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("dt", null, "Adjustment"), /* @__PURE__ */ React.createElement("dd", null, review.adjustment)), /* @__PURE__ */ React.createElement("dt", null, "Shared"), /* @__PURE__ */ React.createElement("dd", null, review.checkInCompleted ? "Yes" : "Not marked shared")), /* @__PURE__ */ React.createElement("div", { className: "wb-history-actions" }, /* @__PURE__ */ React.createElement("button", { className: "wb-secondary-button", type: "button", onClick: () => onReopenReview(review.id) }, /* @__PURE__ */ React.createElement(Icon, { name: "edit", size: 17, stroke: 2 }), "Reopen"), /* @__PURE__ */ React.createElement("button", { className: "wb-secondary-button", type: "button", onClick: () => copySummary(goalReviewSummary(review), "Saved week of " + displayDate(review.weekOf)) }, /* @__PURE__ */ React.createElement(Icon, { name: "link", size: 17, stroke: 2 }), "Copy summary"), /* @__PURE__ */ React.createElement("button", { className: "wb-danger-button", type: "button", onClick: () => onDeleteReview(review.id) }, /* @__PURE__ */ React.createElement(Icon, { name: "trash", size: 17, stroke: 2 }), "Delete")));
    }))));
  }
  ...
  function MindsetWorkbook() {
    ...
    const goalWorksheetProgress = goalSettingUnit ? curriculumUnitProgress(goalSettingUnit, workbook.curriculum, linkedCurriculumProgress) : { complete: 0, total: 0 };
    ...
    function saveGoalWeek() {
      ...
      updateWorkbook((current) => {
        ...
        const existing = goalSystem.reviews.find((review2) => review2.weekOf === goalSystem.currentWeek.weekOf);
        const review = goalReviewFromSystem(goalSystem, existing ? existing.id : void 0);
        if (existing) review.createdAt = existing.createdAt;
        const reviews = existing ? [review].concat(goalSystem.reviews.filter((item) => item.id !== existing.id)) : [review].concat(goalSystem.reviews);
        return {
          ...current,
          goalSystem: {
            ...goalSystem,
    ...
    const linkedModuleBackLabel = returnToCurriculumFromLinked === "goal-unit" ? "Goal Setting worksheets" : returnToCurriculumFromLinked ? "Development worksheet" : void 0;
    if (activeModule === "goal-system") activeContent = /* @__PURE__ */ React.createElement(
      GoalSystemModule,
      {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "wb-workbook" }, /* @__PURE__ */ React.createElement("header", { className: "wb-workbook-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "wb-eyebrow" }, "Device-local athlete workspace"), /* @__PURE__ */ React.createElement("h1", null, "Mindset Workbook"), /* @__PURE__ */ React.createElement("p", null, "Use the complete worksheet program, your personal goal system, quick match tools, and saved plans in one phone-first workspace.")), /* @__PURE__ */ React.createElement("div", { className: "wb-save-status wb-save-status-" + saveStatus.kind, role: "status", "aria-live": "polite", "aria-atomic": "true" }, /* @__PURE__ */ React.createElement(Icon, { name: saveStatus.kind === "error" ? "close" : "check", size: 17, stroke: 2.3 }), /* @__PURE__ */ React.createElement("span", null, saveStatus.message))), /* @__PURE__ */ React.createElement(
      ...
      activeContent || /* @__PURE__ */ React.createElement("section", { className: "wb-dashboard", "aria-labelledby": "wb-dashboard-title" }, /* @__PURE__ */ React.createElement("header", { className: "wb-dashboard-header" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("p", { className: "wb-eyebrow" }, "Your local workbook"), /* @__PURE__ */ React.createElement("h2", { id: "wb-dashboard-title", tabIndex: "-1" }, "Choose a module")), /* @__PURE__ */ React.createElement("p", null, "Responses are not published, but anyone using this same browser profile can view them.")), /* @__PURE__ */ React.createElement("div", { className: "wb-module-grid" }, /* @__PURE__ */ React.createElement(
        DashboardCard,
        {
          ...
          summary: nonEmpty(workbook.goalSystem.goal.title) ? workbook.goalSystem.goal.title + (goalWeekProgress.target ? " · " + goalWeekProgress.completed + " of " + goalWeekProgress.target + " action reps complete this week." : " · Add weekly actions to start scoring the work.") : "Turn the Goal Setting worksheets into one personal plan you can use every week.",
